...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden bg-neutral-950 max-w-screen-xl rounded-md z-0',
        className
      )}
    >
      <div className="relative flex max-w-screen-xl flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
